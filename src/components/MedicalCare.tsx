...
export default function MedicalCare() {
  const careServices = [
    {
      ...
      description: "Each resident has a customized care plan developed by our licensed care team",
      details: [
    ...
    },
    {
      ...
      description: "Safe, accurate medication management following strict protocols",
      details: [
    ...
    },
    {
      ...
      description: "Licensed care team oversight ensures quality care and early intervention",
      details: [
    ...
    },
    {
      ...
      description: "Continuous monitoring of vital signs and health changes",
      details: [
  ...
  return (
    <section id="medical-care" className="py-20 bg-gradient-to-br from-slate-50 to-blue-50 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div>
            ...
            <div className="space-y-4 mb-8">
              {[
                { icon: Shield, text: "Licensed medication administration", color: "bg-blue-100 text-blue-600" },
        ...
        >
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative">
              <ImageWithFallback
                src="https://images.unsplash.com/photo-1576091160399-112ba8d25d1f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxyZXNwaXRlJTIwY2FyZSUyMGVsZGVybHl8ZW58MXx8fHwxNzM1Mzk2OTEyfDA&ixlib=rb-4.1.0&q=80&w=1080"
                alt="Comfortable respite care room"
        ...
        <motion.div
          ...
          className="text-center"
        >
          <h3 className="text-3xl font-bold text-slate-900 mb-4">Questions About Medical Care?</h3>
